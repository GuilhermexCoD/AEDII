...
class TP01Q15_IsRecursivo{
    ...
    */
    public static boolean isInteger(String value){
        ...
        boolean result = isInteger(value,0);
    ...
    * Is Integer.
    * 
    * Este metodo recursivo retorna True se a String em questao for um numero inteiro.
    * @param value String alvo.
    */
    public static boolean isInteger(String value,int index){
        ...
        if(index < value.length()){
            ...
            if(!isInteger(item)){
                ...
                result = (isInteger(value, index + 1));
            }
    ...
    */
    public static boolean isReal(String value){
        ...
        boolean result = isReal(value,0,0);
    ...
    * @param value String alvo.
    */
    public static boolean isReal(String value,int index,int count){
        ...
        if(index < value.length()){
            ...
            if(!isInteger(item)){
                ...
                if(realCount < 1 && (item == '.' || item == ',')){
                    ...
                    result = isReal(value,index + 1,realCount);
