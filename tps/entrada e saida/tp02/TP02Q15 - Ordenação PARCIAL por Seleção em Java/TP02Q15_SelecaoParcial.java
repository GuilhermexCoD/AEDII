...
class TP02Q15_SelecaoParcial{
    ...
    */ 
    ...
    public static void main(String[] args){
        ...
        //metodo de ordenacao
        jogadores = sortSelection(jogadores,10);
        ...
        Arq.openWriteClose("718116_selecao_parcial.txt",result);
    ...
    public static Jogador[] sortSelection(Jogador[] jogadores,int k) {
