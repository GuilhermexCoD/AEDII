...
void cloneJogador(struct Jogador* toClone,struct Jogador* receiver){
    ...
    receiver->name = toClone->name;
    receiver->altura = toClone->altura;
    receiver->peso = toClone->peso;
    receiver->universidade = toClone->universidade;
    receiver->anoNascimento = toClone->anoNascimento;
    receiver->cidadeNascimento = toClone->cidadeNascimento;
    receiver->estadoNascimento = toClone->estadoNascimento;
}
