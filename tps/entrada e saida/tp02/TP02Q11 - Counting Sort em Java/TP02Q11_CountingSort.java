...
class TP02Q11_CountingSort{
    ...
    */ 
    ...
    public static void main(String[] args){
        ...
        jogadores = sortCounting(jogadores);
    ...
    public static Jogador[] sortSelection(Jogador[] jogadores) {
        ...
        for (int i = 0; i < (n - 1); i++) {
            ...
            jogadores = swap(jogadores,menor, i);
        }

        return jogadores;
    }
    
    public static Jogador[] sortCounting(Jogador[] jogadores) {

        int n = jogadores.length;
        //Array para contar o numero de ocorrencias de cada elemento
        int[] limits = getLimits(jogadores);
        //MyIO.println(String.format("Menor altura: %d \nMaior altura: %d",limits[0],limits[1]));
        int menorAltura = limits[0];
        int maiorAltura = limits[1];
        //delta das alturas 
        int countLength = maiorAltura-menorAltura;

        int[] count = new int[countLength + 1];
        Jogador[] ordenado = new Jogador[n];

        //Inicializar cada posicao do array de contagem 
        for (int i = 0; i < count.length; count[i] = 0, i++);
        //MyIO.println("Initilizing count array");
        //print(count);

        //Agora, o count[i] contem o numero de elemento iguais a i
        for (int i = 0; i < n; count[jogadores[i].getAltura()-menorAltura]++, i++);
        //MyIO.println("Adding altura count");
        //print(count);

        //Agora, o count[i] contem o numero de elemento menores ou iguais a i
        for(int i = 1; i < count.length; count[i] += count[i-1], i++);
        //MyIO.println("Adding last index to next");
        //print(count);

        //Ordenando
        for(int i = n-1; i >= 0;i--){
            int indexJogadorAltura = jogadores[i].getAltura()-menorAltura;
            ordenado[count[indexJogadorAltura]-1] = jogadores[i];
            count[indexJogadorAltura]--;
        }
        //MyIO.println("Sorting");
        //print(count);
    ...
    /**
	 * Retorna os limites pegando o jogador com menor altura e jogador com maior altura dentre todos os jogadores.
     * @return maior altura
	 */
	public static int[] getLimits(Jogador[] jogadores) {
        int n = jogadores.length;
        ...
        int[] limits = new int[]{menor,maior};
        return limits;	
     }
